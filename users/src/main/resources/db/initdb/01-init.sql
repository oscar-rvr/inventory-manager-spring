...
(
    ...
    CONSTRAINT fk_purchases_vendor FOREIGN KEY
(
    vendor_id
) REFERENCES vendors
(
...
(
    ...
    CONSTRAINT fk_purchase_details_purchase FOREIGN KEY
(
    purchase_id
...
(
    ...
    CONSTRAINT fk_purchase_details_asset FOREIGN KEY
(
    asset_id
) REFERENCES assets
(
...
(
    ...
    CONSTRAINT fk_users_employee FOREIGN KEY
(
    employee_id
...
(
    ...
    CONSTRAINT fk_assets_movements_employee FOREIGN KEY
(
    employee_id
) REFERENCES employees
(
    ...
    CONSTRAINT fk_assets_movements_asset FOREIGN KEY
(
    asset_id
) REFERENCES assets
(
...
(
    ...
    screen_state VARCHAR
(
    50
) NOT NULL,
    keyboard_state VARCHAR
(
    50
) NOT NULL,
    shell_state VARCHAR
(
    ...
    comments TEXT,
    CONSTRAINT fk_computers_asset FOREIGN KEY
(
    asset_id
) REFERENCES assets
(
